...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Personal IA" },
      ...
      { name: "google-site-verification", content: "1emTLG_6zyCjY84M65p4JMZ6w-LpErKuXTcPH9Ca4e4" },
    ],
    links: [
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="pt-BR" className="dark" data-theme="charcoal-ember" suppressHydrationWarning>
      <head>
        <HeadContent />
